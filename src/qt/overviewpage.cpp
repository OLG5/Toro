...
//Color Control for incoming address
        painter->setPen(fUseBlackTheme ? QColor(255, 255, 255) : QColor(213, 213, 210));
        ...
        //Color Control for amount received
        painter->setPen(fUseBlackTheme ? QColor(255, 255, 255) : QColor(213, 213, 210));
        ...
        painter->setPen(fUseBlackTheme ? QColor(96, 101, 110) : QColor(145, 151, 161));
    ...
    filter(0)
{
    ...
    if (fUseBlackTheme)
    {
        const char* whiteLabelQSS = "QLabel { color: rgb(32,243,68); }";
...
void OverviewPage::setBalance(qint64 balance, qint64 stake, qint64 unconfirmedBalance, qint64 immatureBalance, qint64 anonymizedBalance)
{
    ...
    const char* moneyLabelQSS = "QLabel { color: rgb(18,198,48); }";
    const char* pendLabelQSS = "QLabel { color: rgb(240,204,23); }";
    ui->labelBalance->setText(BitcoinUnits::formatWithUnit(unit, balance));
    ui->labelBalance->setStyleSheet(moneyLabelQSS);
    ui->labelStake->setText(BitcoinUnits::formatWithUnit(unit, stake));
    ui->labelStake->setStyleSheet(moneyLabelQSS);
    ui->labelUnconfirmed->setText(BitcoinUnits::formatWithUnit(unit, unconfirmedBalance));
    ui->labelUnconfirmed->setStyleSheet(pendLabelQSS);
    ui->labelImmature->setText(BitcoinUnits::formatWithUnit(unit, immatureBalance));
    ui->labelImmature->setStyleSheet(pendLabelQSS);
    ui->labelTotal->setText(BitcoinUnits::formatWithUnit(unit, balance + stake + unconfirmedBalance + immatureBalance));
    ui->labelTotal->setStyleSheet(moneyLabelQSS);
...
void OverviewPage::updateDarksendProgress()
{
    ...
    int64_t nMaxToAnonymize = nAnonymizeToroCoinAmount*COIN;
