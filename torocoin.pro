...
contains(RELEASE, 1) {
    ...
    macx:QMAKE_CXXFLAGS += -mmacosx-version-min=10.7 -DOS_MACOSX -DLEVELDB_PLATFORM_POSIX -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.13.sdk
...
macx:ICON = src/qt/res/icons/torocoin.icns
macx:TARGET = "ToroCoin-Qt"
